...
def test_layout_cell_positions_nested_layout_content_with_padding():
    ...
    content = Layout(0, 0, 100, 40, 1, 1, LayoutStyle(column_size=30, row_size=20, padding=(2, 4, 3, 5)))
    cell.content = content
...
def test_layout_distributes_flexible_cells_and_margins():
    layout = Layout(10, 20, 100, 60, 2, 2, LayoutStyle(cell_margin=(4, 6)))
...
def test_layout_cell_span_covers_intervening_margin():
    layout = Layout(0, 0, 100, 40, 1, 2, LayoutStyle(cell_margin=(4, 0)))
...
def test_layout_resize_event_propagates_through_nested_layouts():
    outer = Layout(0, 0, 100, 100, 1, 1)
    inner = Layout(0, 0, 100, 100, 1, 1)
...
def test_layout_fit_to_content_uses_calculated_cell_sizes_and_margins():
    layout = Layout(0, 0, 1, 1, 2, 2, LayoutStyle(row_size=10, column_size=20, cell_margin=(3, 5)))
...
def test_single_sequence_layout_append_and_remove(layout_type):
    layout = layout_type(0, 0, 100, 100)
