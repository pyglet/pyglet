...
from pyglet.libs.egl import (
    ...
    EGL_CONTEXT_MAJOR_VERSION, EGL_RENDER_BUFFER, EGLNativeDisplayType
)
...
result = egl.eglChooseConfig(display_connection, config_attrib_array, egl_config, 1, num_configs)
...
context_attrib_array = (egl.EGLint * len(context_attribs))(*context_attribs)
context = egl.eglCreateContext(display_connection, egl_config, None, context_attrib_array)
