...
gamepads = pyglet.input.get_game_controllers()
...
left_trigger = Point(position=(90, 360 + (gamepad.lefttrigger * 50)), batch=batch)
right_trigger = Point(position=(630, 360 + (gamepad.lefttrigger * 50)), batch=batch)
