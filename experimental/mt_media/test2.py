...
player.queue(procedural.Sine(0.5, 300, sample_rate=2200))
player.queue(procedural.Sine(0.5, 330, sample_rate=2200))
player.queue(procedural.Sine(0.5, 390, sample_rate=2200))
player.play()
