...
from ctypes import (
    ...
    c_int64, c_char_p, c_ubyte, c_uint, c_long, Union, c_void_p,
)
...
Font = pyglet.libs.linux.x11.xlib.Font
...
glXAllocateMemoryNV = _link_function('glXAllocateMemoryNV', c_void_p, [GLsizei, GLfloat, GLfloat, GLfloat], 'NV_vertex_array_range')
...
PFNGLXALLOCATEMEMORYNVPROC = CFUNCTYPE(c_void_p, GLsizei, GLfloat, GLfloat, GLfloat) 	# /usr/include/GL/glx.h:354
...
glXAllocateMemoryMESA = _link_function('glXAllocateMemoryMESA', c_void_p, [POINTER(Display), c_int, c_size_t, c_float, c_float, c_float], 'MESA_allocate_memory')
...
PFNGLXALLOCATEMEMORYMESAPROC = CFUNCTYPE(c_void_p, POINTER(Display), c_int, c_size_t, c_float, c_float, c_float) 	# /usr/include/GL/glx.h:369
