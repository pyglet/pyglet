...
GPU_DEVICE = None 	# http://developer.download.nvidia.com/opengl/includes/wglext.h:347
PGPU_DEVICE = POINTER(None) 	# http://developer.download.nvidia.com/opengl/includes/wglext.h:347
...
PFNWGLGETEXTENSIONSSTRINGARBPROC = CFUNCTYPE(POINTER(c_char), HDC) 	# http://developer.download.nvidia.com/opengl/includes/wglext.h:379
...
PFNWGLGETEXTENSIONSSTRINGEXTPROC = CFUNCTYPE(POINTER(c_char)) 	# http://developer.download.nvidia.com/opengl/includes/wglext.h:455
...
PFNWGLALLOCATEMEMORYNVPROC = CFUNCTYPE(POINTER(None), GLsizei, GLfloat, GLfloat, GLfloat) 	# http://developer.download.nvidia.com/opengl/includes/wglext.h:516
...
HGPUNV = HANDLE 	# C:\cygwin\home\Alex\pyglet\tools\wgl.h:59
...
'WGL_ERROR_MISSING_AFFINITY_MASK_NV', 'GPU_DEVICE', 'PGPU_DEVICE',
