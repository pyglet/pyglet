...
glVariantubvEXT = _get_function('glVariantubvEXT', [_ctypes.c_uint, _ctypes.POINTER(_ctypes.c_ubyte)], None)
...
glGetVariantBooleanvEXT = _get_function('glGetVariantBooleanvEXT', [_ctypes.c_uint, _ctypes.c_uint, _ctypes.POINTER(_ctypes.c_ubyte)], None)
...
glGetInvariantBooleanvEXT = _get_function('glGetInvariantBooleanvEXT', [_ctypes.c_uint, _ctypes.c_uint, _ctypes.POINTER(_ctypes.c_ubyte)], None)
...
glGetLocalConstantBooleanvEXT = _get_function('glGetLocalConstantBooleanvEXT', [_ctypes.c_uint, _ctypes.c_uint, _ctypes.POINTER(_ctypes.c_ubyte)], None)
