...
GLXFBConfigSGIX = POINTER(None) 	# GL/glxext.h:262
# SGIX_pbuffer (GL/glxext.h:265)
GLXBufferClobberEventSGIX = None 	# GL/glxext.h:267
...
Display = None 	# /usr/include/X11/Xlib.h:519
GLXDrawable = XID 	# /usr/include/GL/glx.h:146
GLXContext = POINTER(None) 	# /usr/include/GL/glx.h:155
# GL/glxext.h:416
...
XVisualInfo = None 	# /usr/include/X11/Xutil.h:281
# GL/glxext.h:462
...
# GL/glxext.h:592
glXGetSyncValuesOML = _link_function('glXGetSyncValuesOML', c_int, [POINTER(Display), GLXDrawable, POINTER(c_int64_t), POINTER(c_int64_t), POINTER(c_int64_t)], 'OML_sync_control')

# GL/glxext.h:593
glXGetMscRateOML = _link_function('glXGetMscRateOML', c_int, [POINTER(Display), GLXDrawable, POINTER(c_int32_t), POINTER(c_int32_t)], 'OML_sync_control')

# GL/glxext.h:594
glXSwapBuffersMscOML = _link_function('glXSwapBuffersMscOML', c_int64_t, [POINTER(Display), GLXDrawable, c_int64_t, c_int64_t, c_int64_t], 'OML_sync_control')

# GL/glxext.h:595
glXWaitForMscOML = _link_function('glXWaitForMscOML', c_int, [POINTER(Display), GLXDrawable, c_int64_t, c_int64_t, c_int64_t, POINTER(c_int64_t), POINTER(c_int64_t), POINTER(c_int64_t)], 'OML_sync_control')

# GL/glxext.h:596
glXWaitForSbcOML = _link_function('glXWaitForSbcOML', c_int, [POINTER(Display), GLXDrawable, c_int64_t, POINTER(c_int64_t), POINTER(c_int64_t), POINTER(c_int64_t)], 'OML_sync_control')

PFNGLXGETSYNCVALUESOMLPROC = CFUNCTYPE(c_int, POINTER(Display), GLXDrawable, POINTER(c_int64_t), POINTER(c_int64_t), POINTER(c_int64_t)) 	# GL/glxext.h:598
PFNGLXGETMSCRATEOMLPROC = CFUNCTYPE(c_int, POINTER(Display), GLXDrawable, POINTER(c_int32_t), POINTER(c_int32_t)) 	# GL/glxext.h:599
PFNGLXSWAPBUFFERSMSCOMLPROC = CFUNCTYPE(c_int64_t, POINTER(Display), GLXDrawable, c_int64_t, c_int64_t, c_int64_t) 	# GL/glxext.h:600
PFNGLXWAITFORMSCOMLPROC = CFUNCTYPE(c_int, POINTER(Display), GLXDrawable, c_int64_t, c_int64_t, c_int64_t, POINTER(c_int64_t), POINTER(c_int64_t), POINTER(c_int64_t)) 	# GL/glxext.h:601
PFNGLXWAITFORSBCOMLPROC = CFUNCTYPE(c_int, POINTER(Display), GLXDrawable, c_int64_t, POINTER(c_int64_t), POINTER(c_int64_t), POINTER(c_int64_t)) 	# GL/glxext.h:602
...
GLXHyperpipeNetworkSGIX = None 	# GL/glxext.h:612
GLXHyperpipeConfigSGIX = None 	# GL/glxext.h:617
GLXPipeRect = None 	# GL/glxext.h:625
GLXPipeRectLimits = None 	# GL/glxext.h:631
# GL/glxext.h:637
...
# GL/glxext.h:670
glXAllocateMemoryNV = _link_function('glXAllocateMemoryNV', POINTER(None), [GLsizei, GLfloat, GLfloat, GLfloat], 'NV_vertex_array_range')
...
PFNGLXALLOCATEMEMORYNVPROC = CFUNCTYPE(POINTER(None), GLsizei, GLfloat, GLfloat, GLfloat) 	# GL/glxext.h:675
...
'GLX_BACK_RIGHT_EXT', 'GLX_AUX0_EXT', 'GLX_AUX1_EXT', 'GLX_AUX2_EXT',
'GLX_AUX3_EXT', 'GLX_AUX4_EXT', 'GLX_AUX5_EXT', 'GLX_AUX6_EXT',
'GLX_AUX7_EXT', 'GLX_AUX8_EXT', 'GLX_AUX9_EXT', 'GLX_ARB_multisample',
'GLX_ARB_fbconfig_float', 'GLX_SGIS_multisample', 'GLX_EXT_visual_info',
'GLX_SGI_swap_control', 'glXSwapIntervalSGI', 'PFNGLXSWAPINTERVALSGIPROC',
'GLX_SGI_video_sync', 'glXGetVideoSyncSGI', 'glXWaitVideoSyncSGI',
'glXGetRefreshRateSGI', 'PFNGLXGETVIDEOSYNCSGIPROC',
'PFNGLXWAITVIDEOSYNCSGIPROC', 'PFNGLXGETREFRESHRATESGIPROC',
'GLX_SGI_make_current_read', 'glXMakeCurrentReadSGI',
'glXGetCurrentReadDrawableSGI', 'PFNGLXMAKECURRENTREADSGIPROC',
'PFNGLXGETCURRENTREADDRAWABLESGIPROC', 'GLX_SGIX_video_source',
...
'glXFreeContextEXT', 'PFNGLXGETCURRENTDISPLAYEXTPROC',
