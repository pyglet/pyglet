...
glAreTexturesResidentEXT = _get_function('glAreTexturesResidentEXT', [_ctypes.c_int, _ctypes.POINTER(_ctypes.c_uint), _ctypes.POINTER(_ctypes.c_ubyte)], _ctypes.c_ubyte)
