...
PINT8 = POINTER(c_char) 	# C:\cygwin\home\Alex\pyglet\tools\wgl.h:33
...
LPCSTR = POINTER(c_char) 	# C:\cygwin\home\Alex\pyglet\tools\wgl.h:46
...
POINTFLOAT = None 	# C:\cygwin\home\Alex\pyglet\tools\wgl.h:78
PPOINTFLOAT = POINTER(None) 	# C:\cygwin\home\Alex\pyglet\tools\wgl.h:78
GLYPHMETRICSFLOAT = None 	# C:\cygwin\home\Alex\pyglet\tools\wgl.h:83
PGLYPHMETRICSFLOAT = POINTER(None) 	# C:\cygwin\home\Alex\pyglet\tools\wgl.h:83
LPGLYPHMETRICSFLOAT = POINTER(None) 	# C:\cygwin\home\Alex\pyglet\tools\wgl.h:83
...
LAYERPLANEDESCRIPTOR = None 	# C:\cygwin\home\Alex\pyglet\tools\wgl.h:99
PLAYERPLANEDESCRIPTOR = POINTER(None) 	# C:\cygwin\home\Alex\pyglet\tools\wgl.h:99
LPLAYERPLANEDESCRIPTOR = POINTER(None) 	# C:\cygwin\home\Alex\pyglet\tools\wgl.h:99
...
WGLSWAP = None 	# C:\cygwin\home\Alex\pyglet\tools\wgl.h:184
PWGLSWAP = POINTER(None) 	# C:\cygwin\home\Alex\pyglet\tools\wgl.h:184
LPWGLSWAP = POINTER(None) 	# C:\cygwin\home\Alex\pyglet\tools\wgl.h:184
...
RECT = None 	# C:\cygwin\home\Alex\pyglet\tools\wgl.h:194
PRECT = POINTER(None) 	# C:\cygwin\home\Alex\pyglet\tools\wgl.h:194
NPRECT = POINTER(None) 	# C:\cygwin\home\Alex\pyglet\tools\wgl.h:194
LPRECT = POINTER(None) 	# C:\cygwin\home\Alex\pyglet\tools\wgl.h:194

__all__ = ['GLenum', 'GLboolean', 'GLbitfield', 'GLbyte', 'GLshort', 'GLint',
'GLsizei', 'GLubyte', 'GLushort', 'GLuint', 'GLfloat', 'GLclampf', 'GLdouble',
'GLclampd', 'GLvoid', 'INT8', 'PINT8', 'INT16', 'PINT16', 'INT32', 'PINT32',
'UINT8', 'PUINT8', 'UINT16', 'PUINT16', 'UINT32', 'PUINT32', 'LONG32',
'PLONG32', 'ULONG32', 'PULONG32', 'DWORD32', 'PDWORD32', 'INT64', 'PINT64',
'UINT64', 'PUINT64', 'VOID', 'LPVOID', 'LPCSTR', 'CHAR', 'BYTE', 'WORD',
...
'PGLYPHMETRICSFLOAT', 'LPGLYPHMETRICSFLOAT', 'WGL_FONT_POLYGONS',
'wglUseFontOutlinesA', 'wglUseFontOutlinesW', 'LAYERPLANEDESCRIPTOR',
'PLAYERPLANEDESCRIPTOR', 'LPLAYERPLANEDESCRIPTOR', 'LPD_DOUBLEBUFFER',
'LPD_STEREO', 'LPD_SUPPORT_GDI', 'LPD_SUPPORT_OPENGL', 'LPD_SHARE_DEPTH',
'LPD_SHARE_STENCIL', 'LPD_SHARE_ACCUM', 'LPD_SWAP_EXCHANGE', 'LPD_SWAP_COPY',
'LPD_TRANSPARENT', 'LPD_TYPE_COLORINDEX', 'WGL_SWAP_MAIN_PLANE',
'WGL_SWAP_OVERLAY1', 'WGL_SWAP_OVERLAY2', 'WGL_SWAP_OVERLAY3',
'WGL_SWAP_OVERLAY4', 'WGL_SWAP_OVERLAY5', 'WGL_SWAP_OVERLAY6',
'WGL_SWAP_OVERLAY7', 'WGL_SWAP_OVERLAY8', 'WGL_SWAP_OVERLAY9',
'WGL_SWAP_OVERLAY10', 'WGL_SWAP_OVERLAY11', 'WGL_SWAP_OVERLAY12',
'WGL_SWAP_OVERLAY13', 'WGL_SWAP_OVERLAY14', 'WGL_SWAP_OVERLAY15',
'WGL_SWAP_UNDERLAY1', 'WGL_SWAP_UNDERLAY2', 'WGL_SWAP_UNDERLAY3',
'WGL_SWAP_UNDERLAY4', 'WGL_SWAP_UNDERLAY5', 'WGL_SWAP_UNDERLAY6',
'WGL_SWAP_UNDERLAY7', 'WGL_SWAP_UNDERLAY8', 'WGL_SWAP_UNDERLAY9',
'WGL_SWAP_UNDERLAY10', 'WGL_SWAP_UNDERLAY11', 'WGL_SWAP_UNDERLAY12',
'WGL_SWAP_UNDERLAY13', 'WGL_SWAP_UNDERLAY14', 'WGL_SWAP_UNDERLAY15',
'wglDescribeLayerPlane', 'wglSetLayerPaletteEntries',
'wglGetLayerPaletteEntries', 'wglRealizeLayerPalette', 'wglSwapLayerBuffers',
'WGLSWAP', 'PWGLSWAP', 'LPWGLSWAP', 'WGL_SWAPMULTIPLE_MAX',
