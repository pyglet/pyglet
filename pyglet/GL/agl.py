...
GDevice = None 	# /System/Library/Frameworks/ApplicationServices.framework/Frameworks/QD.framework/Headers/Quickdraw.h:1347
...
GrafPtr = POINTER(None) 	# /System/Library/Frameworks/ApplicationServices.framework/Frameworks/QD.framework/Headers/Quickdraw.h:1009
...
AGLRendererInfo = POINTER(None) 	# /System/Library/Frameworks/AGL.framework/Headers/agl.h:56
AGLPixelFormat = POINTER(None) 	# /System/Library/Frameworks/AGL.framework/Headers/agl.h:57
AGLContext = POINTER(None) 	# /System/Library/Frameworks/AGL.framework/Headers/agl.h:58
AGLPbuffer = POINTER(None) 	# /System/Library/Frameworks/AGL.framework/Headers/agl.h:59
...
'AGLPixelFormat', 'AGLContext', 'AGLPbuffer', 'AGL_ALL_RENDERERS',
...
'AGL_RGBAFLOAT256_BIT', 'AGL_BAD_ATTRIBUTE', 'AGL_BAD_PROPERTY',
'AGL_BAD_PIXELFMT', 'AGL_BAD_RENDINFO', 'AGL_BAD_CONTEXT', 'AGL_BAD_DRAWABLE',
'AGL_BAD_GDEV', 'AGL_BAD_STATE', 'AGL_BAD_VALUE', 'AGL_BAD_MATCH',
'AGL_BAD_ENUM', 'AGL_BAD_OFFSCREEN', 'AGL_BAD_FULLSCREEN', 'AGL_BAD_WINDOW',
'AGL_BAD_POINTER', 'AGL_BAD_MODULE', 'AGL_BAD_ALLOC', 'AGL_BAD_CONNECTION',
'aglChoosePixelFormat', 'aglDestroyPixelFormat', 'aglNextPixelFormat',
'aglDescribePixelFormat', 'aglDevicesOfPixelFormat', 'aglQueryRendererInfo',
'aglDestroyRendererInfo', 'aglNextRendererInfo', 'aglDescribeRenderer',
'aglCreateContext', 'aglDestroyContext', 'aglCopyContext', 'aglUpdateContext',
'aglSetCurrentContext', 'aglGetCurrentContext', 'aglSetDrawable',
'aglSetOffScreen', 'aglSetFullScreen', 'aglGetDrawable',
'aglSetVirtualScreen', 'aglGetVirtualScreen', 'aglGetVersion', 'aglConfigure',
'aglSwapBuffers', 'aglEnable', 'aglDisable', 'aglIsEnabled', 'aglSetInteger',
'aglGetInteger', 'aglUseFont', 'aglGetError', 'aglErrorString',
'aglResetLibrary', 'aglSurfaceTexture', 'aglCreatePBuffer',
'aglDestroyPBuffer', 'aglDescribePBuffer', 'aglTexImagePBuffer',
'aglSetPBuffer', 'aglGetPBuffer', 'aglGetCGLContext', 'aglGetCGLPixelFormat']
