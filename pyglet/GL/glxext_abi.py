...
GLXFBConfigSGIX = POINTER(None) 	# GL/glxext.h:323
# SGIX_pbuffer (GL/glxext.h:326)
GLXBufferClobberEventSGIX = None 	# GL/glxext.h:328
...
PFNGLXGETSYNCVALUESOMLPROC = CFUNCTYPE(c_int, POINTER(Display), GLXDrawable, POINTER(c_int64_t), POINTER(c_int64_t), POINTER(c_int64_t)) 	# GL/glxext.h:635
PFNGLXGETMSCRATEOMLPROC = CFUNCTYPE(c_int, POINTER(Display), GLXDrawable, POINTER(c_int32_t), POINTER(c_int32_t)) 	# GL/glxext.h:636
PFNGLXSWAPBUFFERSMSCOMLPROC = CFUNCTYPE(c_int64_t, POINTER(Display), GLXDrawable, c_int64_t, c_int64_t, c_int64_t) 	# GL/glxext.h:637
PFNGLXWAITFORMSCOMLPROC = CFUNCTYPE(c_int, POINTER(Display), GLXDrawable, c_int64_t, c_int64_t, c_int64_t, POINTER(c_int64_t), POINTER(c_int64_t), POINTER(c_int64_t)) 	# GL/glxext.h:638
PFNGLXWAITFORSBCOMLPROC = CFUNCTYPE(c_int, POINTER(Display), GLXDrawable, c_int64_t, POINTER(c_int64_t), POINTER(c_int64_t), POINTER(c_int64_t)) 	# GL/glxext.h:639
...
GLXHyperpipeNetworkSGIX = None 	# GL/glxext.h:649
GLXHyperpipeConfigSGIX = None 	# GL/glxext.h:654
GLXPipeRect = None 	# GL/glxext.h:662
GLXPipeRectLimits = None 	# GL/glxext.h:668
# GL/glxext.h:674
