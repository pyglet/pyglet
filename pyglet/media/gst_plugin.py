...
Straight ctypes wraps are Gst* classes; higher-level interfaces are Element,
Plugin, etc.
'''
...
class Plugin(object):
    ...
    def register(self):
        ...
        desc = GstPluginDesc(gstreamer.GST_VERSION_MAJOR,
                             gstreamer.GST_VERSION_MINOR,
                             self.name,
                             self.description,
...
class Element(object):
    ...
    def class_init(cls, _class, data):
        ...
        for method in cls.vmethods:
            ...
            print 'added vmethod', c, method

    @classmethod
    def instance_init(cls, _instance, _class):
        print 'instance init', _instance, _class
