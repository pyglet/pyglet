...
glXBindTexImageATI = _get_function('glXBindTexImageATI', [_ctypes.POINTER(Display), GLXPbuffer, _ctypes.c_int], None)
glXReleaseTexImageATI = _get_function('glXReleaseTexImageATI', [_ctypes.POINTER(Display), GLXPbuffer, _ctypes.c_int], None)
glXDrawableAttribATI = _get_function('glXDrawableAttribATI', [_ctypes.POINTER(Display), GLXDrawable, _ctypes.POINTER(_ctypes.c_int)], None)
