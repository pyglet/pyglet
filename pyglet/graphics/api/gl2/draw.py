...
# Default blit source
_blit_vertex_source: str = """#version 110
    attribute vec3 position;
    attribute vec3 tex_coords;
    varying vec3 texture_coords;
...
_blit_fragment_source: str = """#version 110
    varying vec3 texture_coords;
    ...
    void main()
    {
        gl_FragColor = texture2D(our_texture, texture_coords.xy);
    }
"""
...
class Batch(BatchBase):
    ...
    def _convert_to_instanced(self, domain: VertexDomain | IndexedVertexDomain,
                              instance_attributes: Sequence[
                                  str]) -> (InstancedVertexDomain |
    ...
    def get_domain(self, indexed: bool, instanced: bool, mode: GeometryMode, group: Group,
            ...
            VertexDomain | IndexedVertexDomain | InstancedVertexDomain |
            InstancedIndexedVertexDomain):
