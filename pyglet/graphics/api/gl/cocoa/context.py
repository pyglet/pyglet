...
class CocoaOpenGLConfig(OpenGLConfig):

    def match(self, window: CocoaWindow) -> CocoaOpenGLWindowConfig | None:
        ...
        return CocoaOpenGLWindowConfig(window, self, pixel_format)


class CocoaOpenGLWindowConfig(OpenGLWindowConfig):

    def __init__(self, window: CocoaWindow, config: CocoaOpenGLConfig, pixel_format: NSOpenGLPixelFormat) -> None:
