...
from pyglet.graphics.api.gl import link_GLX as _link_function
from pyglet.graphics.api.gl import c_void
...
GLXDrawable = pyglet.backend.gl.x11.glx.GLXDrawable
...
GLXContext = pyglet.backend.gl.x11.glx.GLXContext
# GL/glxext.h:416
...
GLXContextID = pyglet.backend.gl.x11.glx.GLXContextID
# GL/glxext.h:444
...
GLXPixmap = pyglet.backend.gl.x11.glx.GLXPixmap
...
GLsizei = pyglet.backend.gl.x11.glx.GLsizei
GLfloat = pyglet.backend.gl.x11.glx.GLfloat
# GL/glxext.h:670
...
GLvoid = pyglet.backend.gl.x11.glx.GLvoid
# GL/glxext.h:673
glXFreeMemoryNV = _link_function('glXFreeMemoryNV', None, [POINTER(GLvoid)], 'NV_vertex_array_range')

PFNGLXALLOCATEMEMORYNVPROC = pyglet.backend.gl.x11.glx.PFNGLXALLOCATEMEMORYNVPROC
PFNGLXFREEMEMORYNVPROC = pyglet.backend.gl.x11.glx.PFNGLXFREEMEMORYNVPROC
# NV_swap_group (GL/glxext.h:683)
GLX_NV_swap_group = 1 	# GL/glxext.h:684
GLuint = pyglet.backend.gl.x11.glx.GLuint
# GL/glxext.h:686
...
GLXPbuffer = pyglet.backend.gl.x11.glx.GLXPbuffer
# GL/glxext.h:735
