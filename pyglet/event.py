...
This method accepts both positional and keyword parameters. In case of keyword
...
class EventDispatcher:
    ...
    def _get_names_from_handler(self, handler):
        ...
        if callable(handler) and hasattr(handler, '__name__'):
            ...
            # Iterate through all the methods of an object
            # and yield those that match registered events.
